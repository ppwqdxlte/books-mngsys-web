 ...
 * @LastEditors: laowang
 * @LastEditTime: 2023-04-24 10:26:02
...
<template>
  ...
  <el-main>
    ...
    >
      ...
      <div slot="content">
        <el-form ref="addModel" :model="addModel" :rules="rules" label-width="80px" :inline="false" size="small" style="margin-right: 40px;margin-top: 15px;">
          <el-row>
