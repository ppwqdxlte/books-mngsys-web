 ...
 * @LastEditors: laowang
 * @LastEditTime: 2023-04-22 19:13:59
  ...
  <el-main>
    ...
    <el-table :data="userList" border stripe>
      ...
      <el-table-column label="操作">
        <el-button type="primary" icon="el-icon-edit" size="tiny" @click="editBtn">编辑</el-button>
        <el-button type="warning" size="el-icon-delete" size="tiny" @click="deleteBtn">删除</el-button>
      </el-table-column>
    </el-button></el-table>
  </el-main>
</template>
