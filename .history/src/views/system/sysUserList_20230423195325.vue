 ...
 * @LastEditors: laowang
 * @LastEditTime: 2023-04-23 19:52:47
            ...
            <el-col :span="12" :offset="0">
              <el-form-item label="性别">
                <el-radio-group v-model="addModel.sex" @change="sexOnChange">
                  <el-radio v-model="addModel.sex.male" :label="addModel.sex.male" selected="true">男</el-radio>
                  <el-radio v-model="addModel.sex.female" :label="addModel.sex.female">女</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
          </el-row>
