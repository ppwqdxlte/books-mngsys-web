 ...
 * @LastEditors: laowang
 * @LastEditTime: 2023-04-23 19:49:29
...
<template>
  ...
  <el-main>
    ...
    >
      ...
      <div slot="content">
        <el-form ref="addForm" :model="addModel" :rules="rules" label-width="80px" :inline="false" size="small" style="margin-right: 40px;margin-top: 10px;">
          <el-row>
