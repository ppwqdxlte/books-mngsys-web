 ...
 * @LastEditors: laowang
 * @LastEditTime: 2023-04-22 18:12:21
...
<template>
    ...
    <el-main>
        ...
        <!-- 搜索栏，el-form就是form标签，
            ...
            :inline     -是否同一行显示  -->
        <el-form :model="userParamList" ref="userSearchRef" label-width="80px" :inline="false" size="small">
            <!-- el-form-item 表单项
                label       -文字标签 -->
            <el-form-item>
                <el-input v-model="userParamList.nickName" aria-placeholder="请输入姓名" />
            </el-form-item>
            <el-form-item>
